...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        permutation_mask = np.random.randint(low=0, high=self.obs.shape[0], size=batch_size)
        return self.obs[permutation_mask], self.acs[permutation_mask],\
               self.rews[permutation_mask], self.next_obs[permutation_mask],\
               self.terminals[permutation_mask]
